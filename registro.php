        ...
        <div class="card card-body">
            <form action="save.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="usuario" class="form-control" placeholder="Ingrese su correo">
                </div><br>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success btn-block" name="Registro" value="Registrarse">Registrarse</button><br>
